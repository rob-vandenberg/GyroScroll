@echo off
setlocal
echo [INFO] Loading Developer Command Prompt (64-bit)...
call "C:\Program Files (x86)\Microsoft Visual Studio\18\BuildTools\Common7\Tools\VsDevCmd.bat" -arch=amd64 -no_logo
echo.
...
echo [INFO] Compiling GyroScroll 64-bit with /O2 optimization...
echo.
